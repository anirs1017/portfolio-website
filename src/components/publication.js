                        ...
                        <div className="projects bg-light">
                            <div className="img-container">
                                ...
                                <div className="overlay">
                                    <a className="link" href="https://ieeexplore.ieee.org/document/7977309" target="_blank" rel="noopener noreferrer" >
                                        <div className="text">
                    ...
                    <div className="col-md-4 mb-2 mb-md-0">
                        <div className="projects bg-light">
                            <div className="img-container">
                                ...
                                <div className="overlay">
                                    <a className="link" href="https://ieeexplore.ieee.org/document/8230009" target="_blank" rel="noopener noreferrer" >
                                        <div className="text">
                    ...
                    <div className="col-md-4 mb-2 mb-md-0">
                        <div className="projects bg-light">
                            <div className="img-container">
                                ...
                                <div className="overlay">
                                    <a className="link" href="https://link.springer.com/article/10.1007/s12652-018-1101-z" target="_blank" rel="noopener noreferrer" >
                                        <div className="text">
