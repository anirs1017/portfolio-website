                ...
                <Slider>
                    ...
                    <div className="card m-4">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-center">David Doermann</h5>
                            <h6 className="card-text text-center">Professor, Empire Innovation in AI at University at Buffalo</h6>
                            <p className="card-text">
                                ...
                                >
                                    "Aniruddha is a recent graduate from the MS program in CSE at UB. Independent thinker and very dedicated.
                                    ...
                                    He is highly recommended, and I am sure that the company he ends up with will feel so as well."
                            </ReadMoreAndLess>
                            </p>
                        </div>
                        </div>
                    ...
                    <div className="card m-4">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-center">Shubham Sharma</h5>
                            <h6 className="card-text text-center">Engineer at Qualcomm</h6>
                            <p className="card-text">
                                <ReadMoreAndLess
                                    className="read-more-content"
                                    charLimit={250}
                                ...
                                >
                                    ...
                                    He will be a great asset to the team he is part of and will perform his duties with complete conviction."
                            </ReadMoreAndLess>
                            </p>
                        </div>
                        </div>
