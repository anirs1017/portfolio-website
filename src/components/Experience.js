                ...
                <div className="row">
                    <div className="col-12 mb-5 bg-light">
                        <div className="experience m-4">
                            ...
                            <div className="description">
                                <ul>
                                    <li>Worked on a project for Human Behavior Analysis and Modification using three channels - human text entry, human speechand human facial micro-expressions in the background of Episodic Future Training (EFT) of Behavioral Medicine.</li>
                                    <li>Developed and deployed scripts for Data Engineering, Statistical Analysis and visualization of the text, audio and videodata achieved from the studies.  Produced happiness scores on all three channels through NLP and a Deep Learning modeltrained on the relevant features to study correlation between micro-expressions and reducing impulsive decision making.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 mb-5 bg-light">
                        <div className="experience m-4">
                            ...
                            <div className="description">
                                <ul>
                                    <li>Devised and executed a pipeline for a project aimed at Ground Truth Generation from Biomedical Text Archives for trainingMachine Learning models.</li>
                                    <li>Built an XML parser from scratch for over a million National Institute of Health’s (NIH) Pub Med Central text archivesusing Beautiful Soup 4 and Python3.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="experience m-4">
                            ...
                            <div className="description">
                                <ul>
                                    ...
                                    <li>Used my domain knowledge of AI and Machine Learning in Multimedia (Video, Audio, Text) search solutions to give fasteraccess of documents and videos to corporate customers.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
